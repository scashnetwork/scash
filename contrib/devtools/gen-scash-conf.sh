...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/scash.conf}
...
then
  ...
  echo -e "To safely generate a scash.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example scash.conf file in share/examples/'
...
##
## scash.conf configuration file.
## Generated by contrib/devtools/gen-scash-conf.sh.
##
